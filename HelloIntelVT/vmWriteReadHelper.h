...
#define vm_msrbitmap				0x2004
#define vm_exit_msr_store_address	0x2006
#define vm_exit_msr_load_address	0x2008
#define vm_entry_msr_load_address	0x200a
#define vm_executive_vmcs_pointer	0x200c
#define vm_tsc_offset				0x2010
#define vm_virtual_apic_address		0x2012
...
#define vm_guest_IA32_LBR_CTL		0x2816
...
#define vm_page_fault_error_code_mask 0x4006
#define vm_page_fault_error_code_match 0x4008
#define vm_cr3_target_count			0x400A
...
#define vm_tpr_threshold			0x401c
